...
| Peaking | 16000 Hz | 1.41 | -11.1 dB |
         */// Graphic Equalizer
        this.bands = [
            new BiquadFilterNode(this.audioCtx,{type:'peaking',frequency:21,gain:8.3,Q:2.41,}),
            new BiquadFilterNode(this.audioCtx,{type:'peaking',frequency:48,gain:6.5,Q:2.41,}),
            new BiquadFilterNode(this.audioCtx,{type:'peaking',frequency:65,gain:5.6,Q:2.41,}),
            new BiquadFilterNode(this.audioCtx,{type:'peaking',frequency:90,gain:3.4,Q:2.41,}),
            new BiquadFilterNode(this.audioCtx,{type:'peaking',frequency:450,gain:1.0,Q:2.41,}),
            new BiquadFilterNode(this.audioCtx,{type:'peaking',frequency:800,gain:-2.5,Q:2.41,}),
            new BiquadFilterNode(this.audioCtx,{type:'peaking',frequency:1000,gain:-2.5,Q:2.41,}),
            new BiquadFilterNode(this.audioCtx,{type:'peaking',frequency:2000,gain:2.4,Q:2.41,}),
            new BiquadFilterNode(this.audioCtx,{type:'peaking',frequency:8000,gain:4.5,Q:2.41,}),
            new BiquadFilterNode(this.audioCtx,{type:'peaking',frequency:16000,gain:6.5,Q:2.41,}),
        ];
        /// Parametrc Eq
        this.parametricEq =  new BiquadFilterNode(this.audioCtx,{type:'peaking',frequency:21,gain:8.3,Q:2.41,});
    ...
    /******************************************************* */
        ...
        this.paramEq = ()=>{
             this.source.connect(this.parametricEq);
            this.parametricEq.connect(this.audioCtx.destination);
        }
